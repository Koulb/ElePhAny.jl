...
path_to_calc = "/scratch/apolyukhin/julia_tests/gaas_hse/"#qe_inputs_sym_tst
...
scf_parameters = Dict(
    ...
    :ecutwfc => 80,
    :conv_thr =>1.e-14,# 1e-16,# #1.e-20,#5.e-30
...
iq_list = [i for i in 1:mesh^3]#[i for i in 1:mesh^3] ##[1,2]##[1]#[1,6,8] #
